  ...
  return (
    ...
    <div className='fondo'>
      ...
      <div className='flex_contenedor'>
        ...
        <iframe className='dance_imagen' src="https://www.youtube.com/embed/hN1QUlO76Sw?si=d3mxRp3lJpHpnbMm" title="Dance video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      <div className='contenedor'>
