  ...
  return (
    <div className='fondo'>
      ...
      <div className='flex_contenedor'>
        ...
        <iframe className='dance_imagen' src="https://www.youtube.com/embed/mHvGDwNC8_M?si=co2zMfyWgGkePNW0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
